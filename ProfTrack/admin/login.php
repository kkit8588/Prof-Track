...
<div class="registration vh-100 d-flex flex-column justify-content-center align-items-center">
   ...
   <form id="adminLogin" class="rounded-5 bg-white col-11 col-sm-8 col-md-6 col-lg-5 col-xl-4 row row-gap-2 justify-content-center" >
      <div class="row row-gap-3 flex-column align-items-center  p-5">
         <div class="col-12 ">
            <h3 class="register">Admin-LogIn</h3>
            <!-- ALERT -->
         ...
         <div class="col-12 ">
            <div class="form-floating col-12 ">
              <input type="text" name="Username" class="form-control border-0 " id="floatingInput1" placeholder="Username" autocomplete="off">
         ...
         <div class="col-12 ">
            <div class="form-floating col-12">
              <input type="password" name="Password" class="form-control border-0 " id="floatingInput2" placeholder="Password" autocomplete="off" >
