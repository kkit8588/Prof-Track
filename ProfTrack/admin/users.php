...
<div class="registration vh-100 d-flex flex-column justify-content-center align-items-center">
   ...
   <div class="position-relative">
    <div class="text-center fw-bold text-white">
      <h1 class="display-3" style="font-weight: 900;">ProfTrack - Users</h1>
   ...
   <div class="bg-white col-11 col-sm-10 col-lg-8 col-xl-7 px-4 py-3 shadow rounded-4">
            ...
            <tr>
                ...
                <td>
                  <div class="d-flex column-gap-1">
                    <a href="edit-user.php?userid=<?php echo $row['id']; ?>" target="_blank" class="btn btn-success btn-sm fw-bold">Edit</a>
